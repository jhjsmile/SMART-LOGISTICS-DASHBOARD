...
# 역할별 메뉴 접근 권한
ROLES = {
    "master":         ["조립 라인", "검사 라인", "포장 라인", "생산 현황 리포트", "불량 공정", "수리 리포트", "마스터 관리"],
    "control_tower":  ["생산 현황 리포트", "수리 리포트", "마스터 관리"],
    "assembly_team":  ["조립 라인"],
    "qc_team":        ["검사 라인", "불량 공정"],
    "packing_team":   ["포장 라인"],
    "admin":          ["조립 라인", "검사 라인", "포장 라인", "생산 현황 리포트", "불량 공정", "수리 리포트", "마스터 관리"]
}
...
if st.sidebar.button(
    ...
    st.rerun()
st.sidebar.divider()
for p in ["생산 현황 리포트", "불량 공정", "수리 리포트"]:
    if p in allowed_nav:
        if st.sidebar.button(
